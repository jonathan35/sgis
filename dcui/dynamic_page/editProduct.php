...
session_start();
	...
	if($_FILES['pdf']!='')
	{
		...
		{ 
			...
			case 'vnd.ms-excel': 
				$pdf_path = 'attachment/'.uniqid('').'.xls';
				break; 
...
<br><img src="../../images/space.gif" width="140" height="10"><span class="red02"> Max. size: 10MB. File format: PDF, doc, xls</span>
            ...
            <td colspan="2" align="center" bgcolor="#CCCCCC">
                    <div style="text-shadow: #333333 2px -1px 3px; color:#FFF; font-size:20px; font-weight:bold;">EDIT CONTENT OF DETAIL PAGE</div>   
            </td>
            </tr>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                  <tr>
                    <td align="center">
                      ...
                      <textarea name="description" class="Textareafield" style="width:610px; height:700px;"><?php echo $selected_set['description']?></textarea>
                      </td>
                    </tr>
                  </table>
                </td>
