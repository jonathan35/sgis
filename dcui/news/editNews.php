...
session_start();
	...
	if(mysqli_query($conn, "update events_02 set name='".$_POST['name']."', weblink='".$_POST['weblink']."', briefing='".$brief."', description='".$description."', comment_featured='$feedback', date='".$_POST['date']."' where id='$abc'"))
