...
if(mysqli_query($conn, "insert into events_02 (id, name, image1, image2, image3, pdf_file, weblink, type, briefing, description, comment_featured, date) 
values ('', '".$_POST['name']."', '$file1', '$file2', '$file3', '$pdf', '".$_POST['weblink']."', '$newstype', '$brief', '$description', '$feedback', '".$_POST['date']."')"))
