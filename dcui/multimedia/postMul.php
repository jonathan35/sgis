...
session_start();
	...
	{
			if(mysqli_query($conn, "INSERT INTO file_upload02 (file_id, video_link, subject, file, title, date) 
			VALUES ('', '".$_POST['video_link']."', '".$_POST['subject']."', '$file', '".$_POST['title']."', '".$_POST['date']."')"))		
...
<table width="100%" align="left" cellpadding="2"  cellspacing="2">
	<form name="form1" method="post" action="postMul.php" enctype="multipart/form-data" id="form">
	<tr>
	  <td colspan="2" height="32" class="main_title" align="center" bgcolor="#CCCCCC" valign="middle">UPLOAD VIDEO LINK</td>
	</tr>
	<tr>
    ...
    <tr>
		...
		<td><textarea name="video_link" cols="40" rows="5" class="content"></textarea></td>
	</tr>
    
	<!--<tr>
		<th width="26%" align="right" bgcolor="#EFEFEF" class="content"><p><span class="red">*</span> File to upload :&nbsp;</p>		  </th>
		<td><input name="file" type="file" class="content" size="40"></td>
	</tr> -->
	<tr>
...
<div id="Layer1" style="position:absolute; width:200px; height:49px; z-index:1; left: 740px; top: 4px;">
