...
session_start();
	...
	$brief = $_POST['brief'];
	$default_section = "|".$_SESSION['current_section']."|";
...
if(mysqli_query($conn, "insert into product_section (id, category, name, image1, image2, image3, pdf_file, weblink, type, briefing, description, comment_featured, date) 
values ('', '".$default_section."', '".$_POST['name']."', '$file1', '$file2', '$file3', '$pdf', '".$_POST['weblink']."', '$newstype', '$brief', '$description', '$feedback', '".$_POST['date']."')"))
...
<table width="100%" align="left" cellpadding="2"  cellspacing="3">
	<form name="form1" method="post" action="postTemplate.php" enctype="multipart/form-data">
	<tr>
	...
	<tr>
	  ...
	  <td><input name="file" type="file" id="pdf_file"></td>
	  </tr>
	  <tr>
