...
<?php if ($_SESSION['validation']=='YES') { ?>
			...
			<table cellspacing="1" cellpadding="1" border="0" width="100%">
				...
				<tr><td class="display_txt_bg">
					<table cellspacing="1" cellpadding="1" border="0" width="100%">
						...
						<tr>
							<td align="right"><span class="display_user"><?php echo $postedby ?></span></td>
						</tr>
						<tr>
							<td align="right"><?php echo "ddd".$m ?><?php echo $y ?><?php echo $editstr ?></td>
						</tr>
					</table>
				</td></tr>
			</table>
