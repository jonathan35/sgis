...
<body>
  ...
  <div id="Layer1" style="position:absolute; width:200px; height:49px; z-index:1; left: 696px; top: 4px;">
          ...
          <tr>
            ...
            <tr valign="top">
              ...
              <td width="63%" style="padding:4px; padding-left:10px;"><input name="topbanner" type="file" class="content" size="40">
                <span class="red">
                <br>
                Recommended size: 750px X 200px<br>
Format: jpeg,jpg, gif, png</span></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
...
<input type="submit" name="update" value="Save & Sort" onClick="return deleteProduct5();" title="Save & Sort item(s) position" style="width:90px; color:#333;">
                ...
                <table border="0" cellpadding="4" cellspacing="1" width="100%">
                  <tr>
                    <th width="7%" class="content"> <input name="Input" type="checkbox" value="" onClick="chkAll(this.form, 'productIdList[]', this.checked)">
                    </th>
                    <th width="74%" class="content"><div align="center">Banner</div></th>
                    <th width="19%" class="content" align="center">Position No.</th>
                  </tr>
                  <tr>
                    <td colspan="2"></td>
                  </tr>
                  <?php
					...
					?>
                  <tr>
                    <th width="7%" class="content"> <input type="checkbox" value="<?php echo $row_Rs1['banner_id']; ?>" name="productIdList[]">
                     <input name="productIdListUpdate[]" type="hidden" value="<?php echo $row_Rs1['banner_id'];?>"> <br />
                    </th>

                    <td align="center" class="content"><img src="<?php echo "../../".$row_Rs1['banner_file']?>" width="325" height="100"><br></td>
...
//$height=$height * 0.3;
				?>
                  <tr>
                    ...
                    <td align="center" class="content"><img src="<?php echo "../../".$row_Rs1['banner_file']?>" width="325" height="100"></td>
