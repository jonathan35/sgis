...
if($_POST['update']=='Save'){
	...
	$del_data=mysqli_query($conn, "update dcui_section_cpanel set record='".$category1."' where id=1 ");
	
	$category2=mysqli_real_escape_string($conn, $_POST['category2']);
	$del_data=mysqli_query($conn, "update dcui_section_cpanel set record='".$category2."' where id=37 ");
	
	$category3=mysqli_real_escape_string($conn, $_POST['category3']);
	$del_data=mysqli_query($conn, "update dcui_section_cpanel set record='".$category3."' where id=38 ");
}
...
{
		$query="SELECT * FROM murum_section WHERE  (status=1 or status=0) and length(position)=1 ORDER BY position ASC, maincat_name ASC";
}
else if($_GET['tab']=="approvednotondisplay")
{
	...
	$query2=mysqli_query($conn, "SELECT * FROM murum_section WHERE status=-1 and length(position)=1");
	$total_testimonial_not_on_display = mysqli_num_rows($query2); 
	$query=mysqli_query($conn, "SELECT * FROM murum_section WHERE (status=1 or status=0) and length(position)=1");
    ...
    <td align="left" valign="top">
      <table width="100%" align="left" cellpadding="2"  cellspacing="2" border="0">
        <form name="form1" method="post" action="createCategory.php?add=1" enctype="multipart/form-data">
          <tr>
            <td colspan="3" height="32" class="main_title" align="center" bgcolor="#CCCCCC" valign="middle">CREATE SECTION</td>
          </tr>
          <tr>
...
<td width="32%" rowspan="4" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px #999 dashed; padding:5px;">
              <tr>
                <td colspan="2" class="content01"><strong><u>Available pre-design URL file</u> <img src="../images/Design_template.png"  style="vertical-align:middle" title="Pre-Design"></strong></td>
                
              </tr>
              <tr>
                <td class="content01">1.</td>
                <td class="content01">custom_field.php</td>
              </tr>
              <tr>
                <td class="content01">2.</td>
                <td class="content01">index_content.php</td>
              </tr>
              <tr>
                <td class="content01">3.</td>
                <td class="content01">news.php</td>
              </tr>              
              <tr>
                <td class="content01">4.</td>
                <td class="content01">gallery.php</td>
              </tr>     
              <tr>
                <td class="content01">5.</td>
                <td class="content01">product.php</td>
              </tr>                 
              <tr>
                <td class="content01">6.</td>
                <td class="content01">calendar.php</td>
              </tr> 
              <tr>
                <td class="content01">7.</td>
                <td class="content01">multimedia.php</td>
              </tr>                
              <tr>
                <td class="content01">8.</td>
                <td class="content01">document.php</td>
              </tr>  
          ...
          <tr>
            <th width="30%" align="right" bgcolor="#EFEFEF" class="main_title"><span class="red">*</span>Add Pre-design Section :&nbsp;</th>
            <td width="38%"><input type="text" name="maincatname"></td>
          </tr>
          
          <tr>
            <th width="30%" align="right" bgcolor="#EFEFEF" class="main_title"><span class="red">*</span> URL file:&nbsp;</th>
            <td width="38%"><input type="text" name="url_file"></td>
          </tr>
...
&nbsp;
  ...
  <form name="form1" method="post" action="createCategory.php" enctype="multipart/form-data">
  <tr>
    <td>
        <div style=" border:1px #9C0 solid; padding:2px; margin:10px 3px 10px 3px; background-color:#EFFED8" class="content">
            Max. section &nbsp;
            <input type="text" name="category1" value="<?php echo $category1_set['record']?>" style="width:50px;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Max. main category &nbsp;
            <input type="text" name="category2" value="<?php echo $category2_set['record']?>" style="width:50px;"> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Max. sub category &nbsp;
            <input type="text" name="category3" value="<?php echo $category3_set['record']?>" style="width:50px;"> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="submit" name="update" value="Save" title="Limit the free format section" >
        </div>              
    </td>
  </tr>
</form>
  ...
  <tr>
    <td>
      <table width="630" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="32" align="center" valign="middle" bgcolor="#CCCCCC"><span class="main_title">MANAGE SECTION</span></td>
        </tr>
        <tr>
			...
			if($_GET['tab']=="approvedondisplay"||$_GET['tab']=="") { ?>
			  	...
			  	function deleteProduct1()
				{
					...
					else
					{
                      ...
                      <div id="tab">
                        <ul>
                          <li class="current"><a href="createCategory.php?tab=approvedondisplay" title="Activate Product Item Online" class="content">Activated (
                                <?php if ($total_testimonial_on_display!=0){ echo $total_testimonial_on_display;}else{?>
                            0
                            <?php }?>
                            )</a></li>
                          <li class=""><a href="createCategory.php?tab=approvednotondisplay" title="Not Activate Product Item Online" class="content">Unactivated (
...
<input type="submit" name="update" value="Unlock" onClick="return deleteProduct5();" title="Unlock item(s)" style="width:90px; color:#333;">
				...
				?>
                        <tr bgcolor="<?php echo $bgcolor;?>">
                          ...
                          <input type="checkbox" value="<?php echo $row_Rs1['maincat_id']; ?>" name="productIdList[]" >&nbsp;
                            ...
                            <?php if($row_Rs1['status']=="1"){?><img src="../images/view.gif" style="vertical-align:middle" title="On Display"><?php }elseif($row_Rs1['status']=="0"){?><img src="../images/view02.jpg" style="vertical-align:middle" title="Not On Display"><?php }?>
			  	...
			  	function deleteProduct2()
				{
					...
					else
					{
                      ...
                      <div id="tab">
                        <ul>
                          <li class=""><a href="createCategory.php?tab=approvedondisplay" title="Activate Product Item Online" class="content">Activated (
                                <?php if ($total_testimonial_on_display!=0){ echo $total_testimonial_on_display;}else{?>
                            0
                            <?php }?>
                            )</a></li>
                          <li class="current"><a href="createCategory.php?tab=approvednotondisplay" title="Not Activate Product Item Online" class="content">Unactivated (
                                <?php if ($total_testimonial_not_on_display!=0){echo $total_testimonial_not_on_display;}else{?>
                            0
                            <?php }?>
                            )</a></li>
