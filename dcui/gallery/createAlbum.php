...
//*************************************************Edit Country*************************************************
		...
		do
		{
			...
			{	
				...
				$insertSQL1 = "UPDATE album SET album_name='".$_POST['album_name'.$row_Rs1['album_id']]."', position='".$_POST['position'.$row_Rs1['album_id']]."' WHERE album_id='$id_data'"; 
	...
	$selected_section_query=mysqli_query($conn, "SELECT * FROM album WHERE album_id='".$_GET['id']."' ");
