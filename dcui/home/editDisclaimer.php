...
session_start();
	...
	if(mysqli_query($conn, "update home_section set description='$description', date='".date("Y-m-d")."' where id=3"))
	$save='<font color=#336600>Successful</font>';
	else
	$save='<font color=#CC3300>Failed</font>';
}
$selected_query=mysqli_query($conn, "select * from home_section where id=3");
...
<table width="100%" align="left" cellpadding="2"  cellspacing="3">
	<form name="form1" method="post" action="editDisclaimer.php" enctype="multipart/form-data">
	<tr>
	  <td colspan="2" height="32" class="main_title" align="center" bgcolor="#CCCCCC" valign="middle">EDIT CONTACT US</td>
	</tr>
	<tr>
