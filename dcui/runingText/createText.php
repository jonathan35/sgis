...
//*************************************************Edit Country*************************************************
		...
		do
		{
			...
			{	
				...
				$insertSQL1 = "UPDATE runing_text SET album_name='".$_POST['album_name'.$row_Rs1['album_id']]."', position='".$_POST['position'.$row_Rs1['album_id']]."' WHERE album_id='$id_data'"; 
	...
	$selected_section_query=mysqli_query($conn, "SELECT * FROM runing_text WHERE album_id='".$_GET['id']."' ");
  ...
  <tr>
    <td align="left" valign="top">
      <table width="100%" align="left" cellpadding="2"  cellspacing="2" border="0">
        <form name="form1" method="post" action="createText.php?add=1" enctype="multipart/form-data">
          <tr>
