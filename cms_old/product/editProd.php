...
session_start();
	...
	if($_FILES['photo3']!='')
		...
		if($_FILES['brand']!='')
		{
			$file_source4 = $HTTP_POST_FILES['brand']['tmp_name'];
			$type = $HTTP_POST_FILES['brand']['type']; 
			$file4 = ''; 
			$ext = substr(strrchr($type, "/"), 1);
...
<table width="100%" align="left" cellpadding="2"  cellspacing="3">
	<form name="form1" method="post" action="editProd.php?id=<?php echo $defenders->escapeInjection($_GET['id']);?>" enctype="multipart/form-data">
	<tr>
...
<th align="right" bgcolor="#EFEFEF" class="main_title" valign="top"><?php echo image02("$field")?></th>
          <td width="80%" class="content"> Photo 1&nbsp;&nbsp;&nbsp;<?php if($selected['image1']!=''){?><a href="editProd.php?<?php echo $_SERVER['QUERY_STRING']?>&wp=1"><img src="../images/b_drop.png" width="16" height="15" border="0"></a><?php }?><br>
	...
	<tr valign="top">
		<th align="right" bgcolor="#EFEFEF" class="main_title"><?php echo image03("$field")?></th>
		<td align="left" class="content">Brand Logo<br>
        <?php if($selected['brand_logo']!=''){?><a href="editProd.php?<?php echo $_SERVER['QUERY_STRING']?>&wp=1"><img src="../images/b_drop.png" width="16" height="15" border="0"></a><?php }?><br>
				<?php if($selected['brand_logo']!=''&& file_exists("../../".$selected['brand_logo'])){$photo2="../../".$selected['brand_logo'];}else{$photo2='../images/no_photo.gif';}?>
                  <img name="thisImage2" id="thisImage2" src="<?php echo $photo2?>" width="53" height="40"><br>
