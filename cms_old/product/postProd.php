...
if(mysqli_query($conn, "insert into product_section (id, name, image1, image2, image3, brand_logo, pdf_file, weblink, type, briefing, description, date) 
values ('', '".$nameP."', '$file1', '$file2', '$file3', '$file4', '$pdf', '".$weblinkP."', '$newstype', '$brief', '$description', '".$dateP."')"))
