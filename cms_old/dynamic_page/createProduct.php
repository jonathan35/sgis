...
<table width="630" border="1" cellspacing="0" cellpadding="0">
   <?php 	if($limitation>=$dcui_limit_set['record']){ echo "<tr><td class=\"content\" align=\"center\"><br><br><br><br><br><br><br><br><br><br>Max Free Format page is limited to ".$dcui_limit_set['record']." only, please delete some page before you can create the new one.<br><br><br><br><br><br><br><br><br><br><br><br><br></td></tr>";}else{?>
  ...
  <tr>
    <td align="left" valign="top">
      <table width="100%" align="left" cellpadding="2"  cellspacing="2" border="0">
        <form name="form1" method="post" action="createProduct.php?add=1&main=<?php echo $_GET['main']?>" enctype="multipart/form-data">
          <tr>
		  ...
		  <?php do{?>
		  <option value="<?php echo $category_set['maincat_id']; ?>" > <?php echo $category_set['maincat_name']; ?></option>
