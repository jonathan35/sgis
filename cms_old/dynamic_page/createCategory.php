	...
	if (in_array("2", $val_count) || in_array("3", $val_count) || in_array("4", $val_count) || in_array("5", $val_count) || in_array("6", $val_count)) {
		...
		if(!empty($_POST['productIdListUpdate']))
		{
			...
			if($_FILES['upld_photo'.$items_update]!='')
				{	
					$file_name = $HTTP_POST_FILES['upld_photo'.$items_update]['name'];
					$file_source = $HTTP_POST_FILES['upld_photo'.$items_update]['tmp_name'];
					$type = $HTTP_POST_FILES['upld_photo'.$items_update]['type']; 
			...
			if($_FILES['brand'.$items_update]!='')
				{
					$file_name = $HTTP_POST_FILES['brand'.$items_update]['name'];
					$file_source = $HTTP_POST_FILES['brand'.$items_update]['tmp_name'];
					$type = $HTTP_POST_FILES['brand'.$items_update]['type']; 
					$file02 = ''; 
					$ext = substr(strrchr($type, "/"), 1);
...
<td height="288" align="left" valign="top"><table width="630" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <td>
                    <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#999999">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#FFFEF0"><?php echo $lvl1_curr; ?></td>
                        <td bgcolor="#FFFEF0"><?php if(!empty($lvl1_max)){ echo $lvl1_max; }?></td>
                      </tr>
                      <tr>
                        ...
                        <td bgcolor="#FFFEF0"><?php echo $lvl2_curr; ?></td>
                        <td bgcolor="#FFFEF0"><?php if(!empty($lvl2_max)){ echo $lvl2_max; }?></td>
                      </tr>
                      <tr>
                        ...
                        <td bgcolor="#FFFEF0"><?php echo $lvl3_curr; ?></td>
                        <td bgcolor="#FFFEF0"><?php if(!empty($lvl3_max)){ echo $lvl3_max; }?></td>
                      </tr>
                    </table>
                    </td>
                  </tr>
                        ...
                        <ul>
                          ...
                          <li class="">
                          	<a href="createCategory.php?tab=trash" title="Trash Product Item Online" class="content">
                            	Trash (<?php if ($total_testimonial_trash!=0){ echo $total_testimonial_trash;}else{?>0<?php }?> )</a></li>
                        </ul>
                      </div>
 ...
 <?php if($row_Rs1['photo']!=''&&file_exists("../../photo/".$row_Rs1['photo'])){?>
         ...
         <?php }?>  
                        ...
                        <?php }elseif(strlen($row_Rs1['position']) == 1){?>
