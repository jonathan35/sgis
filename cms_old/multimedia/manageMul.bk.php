<?php require_once('../../Connections/pamconnection.php'); 
	...
	if(!empty($_POST['productIdList']))
	{
		...
		{
			$del_data="UPDATE file_upload02 SET status='-1' WHERE file_id='$items_delete'";
			mysqli_select_db($conn, $database_pamconnection);
...
if($_GET['tab']=="approvedondisplay"||$_GET['tab']=="")
{
	...
	{
		if($_GET['type']!='')
			$query="SELECT * FROM file_upload02 WHERE status=1 AND section='".$_GET['sec']."' and type='".$_GET['type']."' ORDER BY file ASC";
		else
			$query="SELECT * FROM file_upload02 WHERE status=1 AND section='".$_GET['sec']."' ORDER BY file_id DESC";
	}
	else	
...
else if($_GET['tab']=="approvednotondisplay")
{
	...
	{
		if($_GET['type']!='')
			$query="SELECT * FROM file_upload02 WHERE status=0 AND section='".$_GET['sec']."' and type='".$_GET['type']."' ORDER BY file ASC";
		else
			$query="SELECT * FROM file_upload02 WHERE status=0 AND section='".$_GET['sec']."' ORDER BY file_id DESC";
	}
	else	
		$query="SELECT * FROM file_upload02 WHERE status=0 ORDER BY file_id DESC";
}
	...
	$query2=mysqli_query($conn, "SELECT * FROM file_upload02 WHERE status=0");
	$total_testimonial_not_on_display = mysqli_num_rows($query2);
	$query=mysqli_query($conn, "SELECT * FROM file_upload02 WHERE status=1");
...
<table width="799" border="0" cellpadding="0" cellspacing="0" align="center">
  ...
  <tr>
    ...
    <td rowspan="2" align="left" valign="top"><table width="630" border="1" cellspacing="0" cellpadding="0">
      <tr>
        <td height="32" align="center" valign="middle" bgcolor="#CCCCCC"><span class="main_title">MANAGE VIDEO LINK</span> </td>
      </tr>
      <tr>
          ...
          <tr>
            <td width="636" height="244" align="left" valign="top"><div align="left">
              ...
              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="content" id="data">
                <tr>
                  <td width="52%" align="left"><a href="manageMul.php?tab=approvedondisplay">Approved - On Display</a></td>
                  <td width="48%"><?php echo $total_testimonial_on_display; ?></td>
                </tr>
                <tr>
                  <td align="left"><a href="manageMul.php?tab=approvednotondisplay">Approved - Not On Display</a></td>
			...
			if($_GET['tab']=="approvedondisplay"||$_GET['tab']=="") { ?>              
			  ...
			  <script>
                ...
                <div id="tab">
                  <ul>
                    <li class="current"><a href="manageMul.php?tab=approvedondisplay" title="Display Product Item Online" class="content">On Display</a></li>
                    <li class=""><a href="manageMul.php?tab=approvednotondisplay" title="Not Display Product Item Online" class="content">Not On Display</a></li>
                  </ul>
                </div>
                ...
                <table border="0" cellpadding="4" cellspacing="1" width="100%">
                  <tr>
                    ...
                    <th width="54%" class="content">Description </th>
                    <th width="54%" class="content">Source / Type</th>
                  ...
                  <tr>
                    ...
                    <td width="23%" class="content">
                      ...
                      <td class="content"><?php echo $row_Rs1['title']; ?></td>
			  ...
			  <script>
                ...
                <div id="tab">
                  <ul>
                    <li class=""><a href="manageMul.php?tab=approvedondisplay" title="Display Product Item Online" class="content">On Display</a></li>
                    <li class="current"><a href="manageMul.php?tab=approvednotondisplay" title="Not Display Product Item Online" class="content">Not On Display</a></li>
                  </ul>
                </div>
