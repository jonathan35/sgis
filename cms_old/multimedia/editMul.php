...
session_start();
	...
	if($_POST['submit']==' Submit ')
	{
			...
			if(mysqli_query($conn, "UPDATE file_upload02 SET video_link='".$_POST['video_link']."', subject='".$_POST['subject']."', title='".$_POST['title']."', date='".$_POST['date']."' WHERE file_id=".$_GET['file']))		
				$success='<font color=#006633>File Updated..!!</font>';
			else
				$success='<font color=#FF0000>Fail To Update File..!!</font>';						
	}
	
	$selected_file_query=mysqli_query($conn, "select * from file_upload02 where file_id=".$_GET['file']);
...
<table width="100%" align="left" cellpadding="2"  cellspacing="2">
	<form name="form1" method="post" action="editMul.php?file=<?php echo $_GET['file']?>" enctype="multipart/form-data" id="form">
	<tr>
	...
	<tr>
		<th width="26%" align="right" bgcolor="#EFEFEF" class="content"><p><span class="red">*</span> Source / Type</p>		  </th>
    ...
    <tr>
		<th width="26%" align="right" bgcolor="#EFEFEF" class="content"><p>Video Link</p>		  </th>
		<td><textarea name="video_link" cols="40" rows="5" class="content"><?php echo $selected_set['video_link']?></textarea></td>
	</tr>
	<!--<tr>
		<th width="26%" align="right" bgcolor="#EFEFEF" class="content"><p><span class="red">*</span> File to upload :&nbsp;</p>		  </th>
		<td class="content"><input name="filetoupload" id="filetoupload" type="file" class="content" size="40"><br> <a href="<?php //echo $selected_set['file']?>" target="_blank" title="click to view"><?php //echo $selected_set['file']?></a></td>
	</tr> -->
	<tr>
