...
session_start();
	...
	if(mysqli_query($conn, "update home_section set description='$description', date='".date("Y-m-d")."' where id=2"))
...
<table width="100%" align="left" cellpadding="2"  cellspacing="3">
	<form name="form1" method="post" action="editCalendar.php" enctype="multipart/form-data">
	<tr>
	  <td colspan="2" height="32" class="main_title" align="center" bgcolor="#CCCCCC" valign="middle">EDIT CALENDAR SIDE</td>
	</tr>
	<tr>
    ...
    <th width="31%" align="right" bgcolor="#EFEFEF" class="main_title"><span class="red">*</span> Side Panel<br>
                <span class="red">Please make sure width <br>of all 
                the content is <br>limited to 220 pixel. 
				</span>
                </th>
	  <td width="75%" align="left" colspan="2">
	    <textarea name="description" rows="15" cols="55"><?php echo $selected['description']?></textarea>
	    </td>
	  </tr>
