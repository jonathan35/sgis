		...
		if(!empty($_POST['productIdListUpdate']))
		{
			...
			{	 
				...
				if($data_check!=''){
					...
					mysqli_query($conn, "update file_upload set category='".$mcat_name."' where file_id='".$items_update."'");
					$data_final="";
				}else{
					$mcat_name = "";
					mysqli_query($conn, "update file_upload set category='' where file_id='".$items_update."'");
				}
...
if($_POST['delete']=='Delete'){	
	...
	if(!empty($_POST['productIdList']))
	{
		...
		{
			$del_data="DELETE FROM file_upload WHERE file_id='$items_delete'";
			mysqli_select_db($conn, $database_pamconnection);
...
if($_GET['tab']=="approvedondisplay"||$_GET['tab']=="")
{
	if(!empty($_GET['alphabet'])) {
	 ...
	 $query="SELECT * FROM file_upload WHERE status=1 AND name like '$colname1_Rs1%' $get_mcat_query";
	 }
	 else
		$query="SELECT * FROM file_upload WHERE status=1 $get_mcat_query ORDER BY date DESC";
}
else if($_GET['tab']=="approvednotondisplay")
{
	if(!empty($_GET['alphabet'])) {
	 $colname1_Rs1=(get_magic_quotes_gpc()) ? $_GET['alphabet'] : addslashes($_GET['alphabet']);
	 $query="SELECT * FROM file_upload WHERE status=0 AND name like '$colname1_Rs1%' $get_mcat_query";
	 }
	 else	
		$query="SELECT * FROM file_upload WHERE status=0 $get_mcat_query ORDER BY date DESC";
}
	...
	$query2=mysqli_query($conn, "SELECT * FROM file_upload WHERE status=0 $get_mcat_query");
	$total_testimonial_not_on_display = mysqli_num_rows($query2);
	$query=mysqli_query($conn, "SELECT * FROM file_upload WHERE status=1 $get_mcat_query");
	$total_testimonial_on_display = mysqli_num_rows($query);

if($_POST['submit']=='update display')
	{
		if ($_POST['type']!='')
			mysqli_query($conn, "update file_upload set type='".$_POST['type']."' ");			
	}
	$query=mysqli_query($conn, "select * from file_upload");
          ...
          <tr>
			...
			if($_GET['tab']=="approvedondisplay"||$_GET['tab']=="") { ?>              
			  ...
			  <script>
                ...
                <div id="tab">
                  <ul>
                    <li class="current"><a href="manageFile.php?tab=approvedondisplay" title="Display Product Item Online" class="content">On Display (<?php echo $total_testimonial_on_display; ?>)</a></li>
                    <li class=""><a href="manageFile.php?tab=approvednotondisplay" title="Not Display Product Item Online" class="content">Not On Display (<?php echo $total_testimonial_not_on_display; ?>)</a></li>
                  </ul>
                </div>
...
?>                       
					...
					<td class="content" align="center"><a href="editFile.php?file=<?php echo $row_Rs1['file_id']?>"><img src="../images/b_edit.png" width="16" height="15" border="0"></a>
<!--<input type="submit" name="<?php //echo 'changes'.$row_Rs1['file_id'];?>" value="Save Changes">--></td>
				...
				<tr><td colspan="5">
					  ...
					  <tr>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=A">A</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=B">B</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=C">C</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=D">D</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=E">E</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=F">F</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=G">G</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=H">H</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=I">I</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=J">J</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=K">K</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=L">L</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=M">M</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=N">N</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=O">O</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=P">P</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=Q">Q</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=R">R</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=S">S</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=T">T</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=U">U</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=V">V</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=W">W</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=X">X</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=Y">Y</a></strong></span></td>
						<td><span class="content"><strong><a href="manageFile.php?tab=<?php echo $_GET['tab']?>&alphabet=Z">Z</a></strong></span></td>
					  </tr>
					</table>
				  </td></tr>				  				  
                </table>
			  ...
			  <script>
                ...
                <div id="tab">
                  <ul>
                    <li class=""><a href="manageFile.php?tab=approvedondisplay" title="Display Product Item Online" class="content">On Display (<?php echo $total_testimonial_on_display; ?>)</a></li>
                    <li class="current"><a href="manageFile.php?tab=approvednotondisplay" title="Not Display Product Item Online" class="content">Not On Display (<?php echo $total_testimonial_not_on_display; ?>)</a></li>
                  </ul>
                </div>
