...
<tr>
  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" >
        <tr>
          <td align="center"><img src="images/space.gif" width="20" height="10" /></td>
        </tr>
        <tr>
          <td>
			...
			do{
                ...
                <a href="result.php?root=NQ==&detail=<?=base64_encode($product_set['id'])?>" target="_self">
                ...
                <div style="float:left; width:99%;" align="left" class="content_text">
                <?
