...
<div align="center">
  <div id="localnav">
	<div id="menu">
	  ...
	  <ul>
        <li>
      <a href="#" class="<?php echo $var[$current_id];?>" 
	  onClick="return kadabra('<?php echo $current_id?>',this);" >
	  <img src="../images/menu_open.gif" width="10" height="10" />
	  <span class="main_title"> <?php echo substr($section_set['maincat_name'],0,17)?></span> 
	  <img src="../images/Design_template.png" />
	  </a>
