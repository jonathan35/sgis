  ...
  <tr>
    ...
    <td align="left" valign="top">
      ...
      <table width="100%" align="left" cellpadding="2"  cellspacing="2" border="0">
        ...
        <form name="form1" method="post" action="createPhoto.php?add=1&main=<? echo $_GET['main']?>" enctype="multipart/form-data">
          ...
          <tr>
            ...
            <? $category_query=mysqli_query($conn, "select * from album where status=1 order by position asc"); $category_set=mysqli_fetch_assoc($category_query);     ?>
            ...
            <td width="69%"><select name="cat">
              ...
              <option value="<? echo $category_set['album_id']; ?>" <? if($_GET['main']==$category_set['album_id']){?> selected<? }?> > <? echo $category_set['album_name']; ?></option>
            ...
            <tr>
            	...
            	<td><textarea name="desc" style="width:300px;height:150px;"><? echo $selected_set['desc']?></textarea></td>
