...
$header.= 'From: <Weda Choice Feedback Form>' . "\r\n";
...
<table width="600" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr><td>
<table width="100%"  border="0" align="center" cellpadding="4" cellspacing="6" bgcolor="#ccc" class="content">
<tr>
<td colspan="2">&nbsp;</td>
</tr>
<tr>
				  ...
				  ?>
                    ...
                    <td width="4%" class="content"><input type="checkbox" value="<?php echo $row_Rs1['id']; ?>" name="productIdList[]">                     </td>
                      <td align="center">
                        ...
                        <a href="product_enquiry.php?st=<?php echo $_GET['st'];?>&read=yes&id=<?php echo $row_Rs1['id']?>"><img src="../images/read.gif" width="27" height="20" border="0"></a>
                        <?php }?>
                      </td>
