...
session_start();
	...
	$abc=$defenders->escapeInjection(base64_decode($_GET['id']));
	...
	if($_FILES['photo3']!='')
...

		{
			...
			$file_source4 = $_FILES['brand']['tmp_name'];

			$type = $_FILES['brand']['type']; 
			...
			{ 
				...
				if ( move_uploaded_file( $file_source4, "../../".$file4 ) ) 

				{

					mysqli_query($conn, "update product_section set brand_logo='".$file4."' where id='".$abc."'");
	...
	if(mysqli_query($conn, "update product_section set name='".$nameP."', weblink='".$weblinkP."', briefing='".$brief."', description='".$description."', date='".$dateP."' where id='".$abc."'"))
...
<table width="100%" align="left" cellpadding="2"  cellspacing="3">
	...
	<form name="form1" method="post" action="editProd.php?id=<? echo $defenders->escapeInjection($_GET['id']);?>" enctype="multipart/form-data">

	<tr>

	  <td colspan="2" height="32" class="main_title" align="center" bgcolor="#CCCCCC" valign="middle">EDIT PRODUCT </td>
...
<th align="right" bgcolor="#EFEFEF" class="main_title" valign="top"><? echo image02("$field")?></th>

          <td width="80%" class="content"> Photo 1&nbsp;&nbsp;&nbsp;<? if($selected['image1']!=''){?><a href="editProd.php?<? echo $_SERVER['QUERY_STRING']?>&wp=1"><img src="../images/b_drop.png" width="16" height="15" border="0"></a><? }?><br>

				<? if($selected['image1']!=''&& file_exists("../../".$selected['image1'])){$photo1="../../".$selected['image1'];}else{$photo1='../images/no_photo.gif';}?>

                  <img name="thisImage1" id="thisImage1" src="<? echo $photo1?>" width="100" height="75"><br>
	...
	<tr valign="top">
		...
		<th align="right" bgcolor="#EFEFEF" class="main_title"><? echo image03("$field")?></th>

		<td align="left" class="content">Brand Logo<br>

        <? if($selected['brand_logo']!=''){?><a href="editProd.php?<? echo $_SERVER['QUERY_STRING']?>&wp=1"><img src="../images/b_drop.png" width="16" height="15" border="0"></a><? }?><br>

				<? if($selected['brand_logo']!=''&& file_exists("../../".$selected['brand_logo'])){$photo2="../../".$selected['brand_logo'];}else{$photo2='../images/no_photo.gif';}?>

                  <img name="thisImage2" id="thisImage2" src="<? echo $photo2?>" width="53" height="40"><br>

        

        

		<input name="brand" type="file" class="content" onChange="javascript:findItem('thisImage2').src = findItem('brand').value;">
	...
	<tr>
	  ...
	  <th align="right" bgcolor="#EFEFEF" class="content"><? echo attachment("$field")?></th>

	  <td><input name="pdf_file" type="file" id="pdf_file"><?php if($selected['pdf_file']!=''){?> 

		<a href="editProd.php?id=<?php echo $defenders->escapeInjection($_GET['id']);?>&cmd=pdf">
	 ...
	 <tr>
	  ...
	  <th align="right" bgcolor="#EFEFEF" class="content"><span class="main_title"><? echo hyperlink("$field")?></span></th>
	  ...
	  <th align="right" bgcolor="#EFEFEF" class="content"><span class="main_title"><? echo date_field("$field")?></span></th>
	...
	<tr>
		...
		<th align="right" bgcolor="#EFEFEF" class="content" valign="top"><span class="main_title"><? echo brief("$field")?></span></th>

		<td align="left">

		<textarea name="short_description" rows="5" cols="50"><? echo $selected['briefing']?></textarea>
	...
	<tr>
		...
		<th align="right" bgcolor="#EFEFEF" class="content" valign="top"><span class="main_title"><? echo tiny01("$field")?></span></th>

		<td align="left">

		<textarea name="description" rows="15" class="mceEditor" cols="50"><? echo $selected['description']?></textarea>
