		...
		if(!empty($_POST['productIdListUpdate']))
		{
			...
			{	 
				...
				if($data_check!=''){
					...
					mysqli_query($conn, "update product_section set category='".$mcat_name."', 
									position='".$defenders->escapeInjection($_POST['position'.$items_update])."' where id='".$items_update."'");
					$data_final="";
				}else{
					$mcat_name = "";
...
if($_POST['update']=='Hide'){	
	...
	if(!empty($_POST['productIdList']))
	{
		...
		{
			$del_data=mysqli_query($conn, "update product_section set status='0' where id='$items_delete'");
		}
	}
}
if($_POST['update']=='Display'){	
	...
	if(!empty($_POST['productIdList']))
	{
		foreach($items_delete_array as $items_delete)
		{
			$del_data=mysqli_query($conn, "update product_section set status='1' where id='$items_delete'");
		}
	}
}	
...
if($_GET['tab']=="approvedondisplay"||$_GET['tab']=="")
{
	if(!empty($_GET['alphabet'])) {
	 ...
	 $query="SELECT * FROM product_section WHERE status=1 AND name like '$colname1_Rs1%' $get_mcat_query order by position asc, date desc";
	 }
	 else
		$query="SELECT * FROM product_section WHERE status=1 $get_mcat_query ORDER BY position asc, date desc";
}
else if($_GET['tab']=="approvednotondisplay")
{
	if(!empty($_GET['alphabet'])) {
	 $colname1_Rs1=(get_magic_quotes_gpc()) ? $_GET['alphabet'] : addslashes($_GET['alphabet']);
	 $query="SELECT * FROM product_section WHERE status=0 AND name like '$colname1_Rs1%' $get_mcat_query order by position asc, date desc";
	 }
	 else	
		$query="SELECT * FROM product_section WHERE status=0 $get_mcat_query ORDER BY position asc, date desc";
}
...
if($_POST['submit']=='update display')
	{
		if ($_POST['type']!='')
			mysqli_query($conn, "update product_section set type='".$defenders->escapeInjection($_POST['type'])."' ");			
	}
...
<table width="799" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="left" valign="top" colspan="5">
          <div id="title">
            <div id="titlename"><span class="white_title">PRODUCT GROUP</span></div></div>
        </div>	
	</td>
  </tr>
  <tr>
    ...
    <td rowspan="2" align="left" valign="top"><table width="630" border="1" cellspacing="0" cellpadding="0">
      <tr>
        <td height="32" align="center" valign="middle" bgcolor="#CCCCCC"><span class="main_title">MANAGE PRODUCT </span> </td>
      </tr>
      <tr>
        <td height="288" align="left" valign="top"><table width="630" align="left" cellpadding="0"  cellspacing="0">
                ...
                <tr>
                  <td width="72%" align="right">
                                	<?php $qry=mysqli_query($conn, "select * from murum_section where status=1  $filter_section_limit_query order by position asc"); $main=mysqli_fetch_assoc($qry); ?>
          ...
          <tr>
			...
			if($_GET['tab']=="approvedondisplay"||$_GET['tab']=="") { ?>              
              <!--On Display-->
              <form name="ProductListForm1" method="post" action="manageProd.php?tab=approvedondisplay">
			  <script>
                ...
                <div id="tab">
                  <ul>
                    <li class="current"><a href="manageProd.php?tab=approvedondisplay" title="Display Product Item Online" class="content">On Display (<?php echo $total_testimonial_on_display; ?>)</a></li>
                    <li class=""><a href="manageProd.php?tab=approvednotondisplay" title="Not Display Product Item Online" class="content">Not On Display (<?php echo $total_testimonial_not_on_display; ?>)</a></li>
                  </ul>
                </div>
                <div class="function"> <span class="content">Select
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <input type="submit" name="update" value="Hide" onClick="return updateProduct();" title="Not Display This Product At Your Online List"/> 
                ...
                <table border="0" cellpadding="4" cellspacing="1" width="100%">
                  <tr>
                    <th width="5%" class="content">
					 ...
					 <th width="47%" class="content">Item</th>
                    <th width="48%" class="content">Category</th>
                  </tr>
                  ...
                  <tr>
                    ...
                    <?php echo $row_Rs1['name']; ?><a href="editProd.php?id=<?php echo base64_encode($row_Rs1['id'])?>"><img src="../images/b_edit.png" width="16" height="15" border="0"></a><br>
                    <img src="<?php echo "../../".$row_Rs1['image1']; ?>" width="100" border="0"><br>
					
                     Position:<br>
                    <input name="<?='position'.$row_Rs1['id']?>" type="text" value="<?php echo $row_Rs1['position'];?>" style="width:70px;">
...
?>                       
				...
				<tr><td colspan="5">
					  ...
					  <tr>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=A">A</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=B">B</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=C">C</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=D">D</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=E">E</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=F">F</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=G">G</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=H">H</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=I">I</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=J">J</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=K">K</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=L">L</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=M">M</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=N">N</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=O">O</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=P">P</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=Q">Q</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=R">R</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=S">S</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=T">T</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=U">U</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=V">V</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=W">W</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=X">X</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=Y">Y</a></strong></span></td>
						<td><span class="content"><strong><a href="manageProd.php?tab=<?php echo $_GET['tab']?>&alphabet=Z">Z</a></strong></span></td>
					  </tr>
					</table>
				  </td></tr>				  				  
                </table>
              ...
              <form name="ProductListForm2" method="post" action="manageProd.php?tab=approvednotondisplay">
			  <script>
                ...
                <div id="tab">
                  <ul>
                    <li class=""><a href="manageProd.php?tab=approvedondisplay" title="Display Product Item Online" class="content">On Display (<?php echo $total_testimonial_on_display; ?>)</a></li>
                    <li class="current"><a href="manageProd.php?tab=approvednotondisplay" title="Not Display Product Item Online" class="content">Not On Display (<?php echo $total_testimonial_not_on_display; ?>)</a></li>
                  </ul>
                </div>
                ...
                &nbsp;&nbsp;&nbsp;
                    <input type="submit" name="update" value="Save & Update" onClick="return saveUpdate();" title="Save & Update item(s) position" style="width:120px; color:#333;"> &nbsp;&nbsp;&nbsp;
                    <input type="submit" name="update" value="Display" onClick="return updateProduct();" title="Display This Product At Your Online List"/> 
                </div>
                <table border="0" cellpadding="4" cellspacing="1" width="100%">
                  <tr>
                    <th width="5%" class="content">
