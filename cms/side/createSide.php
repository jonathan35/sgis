...
function check()
{
	...
	{
		alert("Please enter the content in the provided field.");
...
<table width="799" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr bgcolor="#FFFFFF">
	...
	<div align="left">
          <div id="title">
            <div class="white_title" id="titlename"><span class="white_title">MODUL PANEL</span></div></div>
          ...
          <tr>
			...
			<tr valign="top">
                ...
                <span class="red">Please make sure all <br>the content for side <br>panel is within the <br>limited width.<br><br>
					...
					Right Panel width is <br>limited to 220 pixel.				</span>                </th>
                <td width="69%"><textarea name="prod_name" class="Textareafield" style="width:400px; height:300px;"></textarea></td>
            </tr>            
