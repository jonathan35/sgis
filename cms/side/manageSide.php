...
if($_POST['update']=='Save & Sort'){	
	...
	if(!empty($_POST['productIdListUpdate']))
	{
		...
		{	 
			...
			$position_value = $_POST['position'.$update_data];
			$left_right = $_POST['left_right'.$update_data];
			
			mysqli_query($conn, "update side_panel set position='".$position_value."', left_or_right='".$left_right."' where id='".$update_data."'");
			...
			////////////Update product's section id////////
				...
				if($data_check!=''){
					...
					mysqli_query($conn, "update side_panel set maincat_id='".$mcat_name."' where id='".$update_data."'");
					$data_final="";
				}else{
					$mcat_name = "";
					mysqli_query($conn, "update side_panel set maincat_id='' where id='".$update_data."'");
				}
			}
	}
}
...
if($_POST['display']=='Hide'){	
	...
	if(!empty($_POST['productIdList']))
	{
		...
		{
			$hide_data="update side_panel set status='0' where id='$items_hide'";
...
if($_POST['display']=='Display'){	
	...
	if(!empty($_POST['productIdList']))
	{
		...
		{
			$display_data="update side_panel set status='1' where id='$items_display'";
			mysqli_select_db($conn, $database_pamconnection);
...
if($_POST['delete']=='Delete'){	
	...
	if(!empty($_POST['productIdList']))
	{
		...
		{
			$display_data="update side_panel set status='-1' where id='$items_delete'";
			mysqli_select_db($conn, $database_pamconnection);
			$dataResult1 = mysqli_query($conn, $display_data) or die(mysqli_error());			
		}
	}
...
if($_GET['tab']=="approvedondisplay"||$_GET['tab']==""){
		if(!empty($_GET['alphabet'])) {
			...
			$query="SELECT * FROM side_panel WHERE status=1 AND side_brief like '$colname1_Rs1%' $get_mcat_query $get_scat_query ORDER BY position asc, side_brief asc";
		 }
		 else
			$query="SELECT * FROM side_panel WHERE status=1 $get_mcat_query $get_scat_query ORDER BY position asc, side_brief asc";
}
else if($_GET['tab']=="approvednotondisplay"){
		if(!empty($_GET['alphabet'])) {
			$colname1_Rs1=(get_magic_quotes_gpc()) ? $_GET['alphabet'] : addslashes($_GET['alphabet']);
			$query="SELECT * FROM side_panel WHERE status=0 AND side_brief like '$colname1_Rs1%' $get_mcat_query $get_scat_query ORDER BY position asc, side_brief asc";
		 }
		 else
			$query="SELECT * FROM side_panel WHERE status=0 $get_mcat_query $get_scat_query ORDER BY position asc, side_brief asc";
}
	...
	$query2=mysqli_query($conn, "SELECT * FROM side_panel WHERE status=0 $get_mcat_query $get_scat_query ");
	$total_testimonial_not_on_display = mysqli_num_rows($query2);
	$query=mysqli_query($conn, "SELECT * FROM side_panel WHERE status=1 $get_mcat_query $get_scat_query");
...
<table width="799" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr>
	...
	<div align="left">
          <div id="title">
            <div id="titlename"><span class="white_title">MODUL PANEL</span></div></div>
...
<tr>
                    <td width="72%" align="right">
                                	<?php $qry=mysqli_query($conn, "select * from murum_section where status=1 and length(position=1) order by position asc"); $main=mysqli_fetch_assoc($qry); ?>
...
<?php $qry02=mysqli_query($conn, "select * from murum_section where status=1 and length(position=2) order by position asc"); $main02=mysqli_fetch_assoc($qry02); ?>
          ...
          <tr>
			...
			if($_GET['tab']=="approvedondisplay"||$_GET['tab']=="") { ?>              
              <!--On Display-->
              <form name="ProductListForm1" method="post" action="manageSide.php?tab=approvedondisplay&pageNum_Rs1=<?php echo $_GET['pageNum_Rs1'];?>&main=<?php echo $_GET['main']?>&sub=<?php echo $_GET['sub']?>">
			  <script>
                ...
                <div id="tab">
                  <ul>
                    <li class="current"><a href="manageSide.php?tab=approvedondisplay&main=<?php echo $_GET['main']?>&sub=<?php echo $_GET['sub']?>" title="Display Product Item Online" class="content">On Display(
                                <?php if ($total_testimonial_on_display!=0){ echo $total_testimonial_on_display;}else{?>
                            0
                            <?php }?>
                            )</a></li>
                    <li class=""><a href="manageSide.php?tab=approvednotondisplay&main=<?php echo $_GET['main']?>&sub=<?php echo $_GET['sub']?>" title="Not Display Product Item Online" class="content">Not On Display (
...
<tr><td>
					  ...
					  <tr>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=A">A</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=B">B</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=C">C</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=D">D</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=E">E</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=F">F</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=G">G</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=H">H</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=I">I</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=J">J</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=K">K</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=L">L</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=M">M</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=N">N</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=O">O</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=P">P</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=Q">Q</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=R">R</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=S">S</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=T">T</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=U">U</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=V">V</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=W">W</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=X">X</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=Y">Y</a></strong></span></td>
						<td><span class="content"><strong><a href="manageSide.php?tab=<?php echo $_GET['tab']?>&alphabet=Z">Z</a></strong></span></td>
					  </tr>
					</table>
				  </td></tr>                
...
<input type="submit" name="update" value="Save & Sort" onClick="return saveProduct();" title="Save & Sort item(s) position" style="width:90px; color:#333;">
                ...
                <table border="0" cellpadding="4" cellspacing="1" width="100%">
                  <tr>
                    <th width="47" class="content">
                      <input name="Input" type="checkbox" value="" onClick="chkAll(this.form, 'productIdList[]', this.checked)">                    </th>
                    <th width="169" class="content">Title</th>
                    <th width="270" class="content">Section & Category</th>
                    <th width="74" class="content" align="center">Position No. </th>
                    <th width="22" class="content" align="center">Edit</th>
                  </tr>
                  <?php
				  $count=1;
					if($row_Rs1!='')
				...
				$bgcolor='#FFFFFF';
                  ...
                  <tr bgcolor="<?php echo $bgcolor;?>">
                    <th width="47" class="content" bgcolor="<?php echo $bgcolor;?>">
					  ...
					  <?php echo $row_Rs1['side_brief']; ?><br>
                      </td>
                     <td class="content" valign="top">
                    
<?
		$root_Rs1 = mysqli_query($conn, "SELECT * FROM murum_section WHERE status=1 and length(position)=1 ORDER BY position ASC, maincat_name ASC");
		$rotcat = mysqli_fetch_assoc($root_Rs1);
		do{
			
	$check_level1_q=mysqli_query($conn, "SELECT * FROM side_panel WHERE maincat_id like '%|".$rotcat['maincat_id']."|%' and maincat_id!='' and id='".$row_Rs1['id']."' ");
...
?>
   ...
   <?php }while($rotcat = mysqli_fetch_assoc($root_Rs1));?>
                    ...
                    <label><input type="radio" name="<?php echo 'left_right'.$row_Rs1['id']?>" value="1" <?php if($row_Rs1['left_or_right']==1){?> checked<?php }?>> Left</label><br>
                    <label><input type="radio" name="<?php echo 'left_right'.$row_Rs1['id']?>" value="2" <?php if($row_Rs1['left_or_right']==2){?> checked<?php }?>> Right</label><br><br> 
                   
                    
                    <input name="<?php echo 'position'.$row_Rs1['id']?>" type="text" value="<?php echo $row_Rs1['position'];?>" style="width:30px;">
                    
                    </td>
                    <td class="content" align="center"><a href="editSide.php?id=<?php echo $row_Rs1['id']?>"><img src="../images/b_edit.png" width="16" height="15" border="0"></a></td>
                  </tr>
                  <?php $count++;
              ...
              <form name="ProductListForm2" method="post" action="manageSide.php?tab=approvednotondisplay&pageNum_Rs1=<?php echo $_GET['pageNum_Rs1'];?>&main=<?php echo $_GET['main']?>&sub=<?php echo $_GET['sub']?>">
			  <script>
                ...
                <div id="tab">
                  <ul>
                    <li class=""><a href="manageSide.php?tab=approvedondisplay&main=<?php echo $_GET['main']?>&sub=<?php echo $_GET['sub']?>" title="Display Product Item Online" class="content">On Display(
                                <?php if ($total_testimonial_on_display!=0){ echo $total_testimonial_on_display;}else{?>
                            0
                            <?php }?>
                            )</a></li>
                    <li class="current"><a href="manageSide.php?tab=approvednotondisplay&main=<?php echo $_GET['main']?>&sub=<?php echo $_GET['sub']?>" title="Not Display Product Item Online" class="content">Not On Display (
                                <?php if ($total_testimonial_not_on_display!=0){echo $total_testimonial_not_on_display;}else{?>
                            0
                            <?php }?>
                            )</a></li>
...
<input type="submit" name="update" value="Save & Sort" onClick="return saveProduct();" title="Save & Sort item(s) position" style="width:90px; color:#333;">
                ...
                <table border="0" cellpadding="4" cellspacing="1" width="100%">
                  <tr>
                    <th width="47" class="content">
                      <input name="Input" type="checkbox" value="" onClick="chkAll(this.form, 'productIdList[]', this.checked)">                    </th>
                    <th width="143" class="content">Title</th>
                    <th width="322" class="content">Section & Category</th>
                    <th width="49" class="content" align="center">Position No. </th>
                    <th width="21" class="content" align="center">Edit</th>
                  </tr>
                  <?php $count=1;
					if($row_Rs1!='')
					{											
