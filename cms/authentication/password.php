...
$query_Recordset1 = "SELECT * FROM qt_login WHERE username='". $_POST['txtname'] ."' AND status=1";
...
if ($_POST['txtpassword'] == $row_Recordset1['password'] && ($totalRows_Recordset1<>0)  && ($valid == true || $_SERVER['HTTP_HOST']=='localhost' || $_SERVER['HTTP_HOST']=='wphp.hopto.org'))
{
	...
	{*/
		...
		?>
<script>
top.location.href = "admin_main.php";
</script>
<?php 
