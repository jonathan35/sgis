          ...
          <td width="636" height="244" align="left" valign="top">
            ...
            <table width="100%" height="244" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top">
                ...
                <img src="../images/WebAndYou.jpg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
              </tr>              
              <tr valign="top">
                <td class="main_title" align="center"><br><br>
                  <br>
                  <br>
                  WELCOME<br>
                  TO<br>
                  WEB AND YOU <br>
                  CONTENT MANAGEMENT</b> SYSTEM</td>
              </tr>
            </table>
          </form>
...
<div id="Layer1" style="position:absolute; width:200px; height:35px; z-index:1; left: 757px; top: 5px;">
