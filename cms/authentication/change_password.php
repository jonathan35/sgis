...
<table width="799" border="0" align="center">
  <tr bgcolor="#FFFFFF">
	...
	<div align="left">
          <div id="title">
            <div id="titlename"><span class="white_title">CHANGE PASSWORD</span></div></div>
...
<table width="100%" align="left" cellpadding="2"  cellspacing="3">
        <tr>
          <td><Form METHOD="post" ACTION="change_password.php">
              <span class="content style7 style12">* <span class="red">Required fields</span></span>
	...
	$sql="SELECT password FROM qt_login WHERE password='".$oldpass."'";
	...
	if($r['password']==$oldpass){
		  if($newpass==$comfirmpass && $newpass!="" && $comfirmpass!="" && $stat=='yes' )
				  {?>
            <?php $insertSQL = "UPDATE qt_login SET password='$newpass' WHERE password='$oldpass'";
