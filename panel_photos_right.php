        ...
        <tr>
          <td background="images/bg_right.gif">
            ...
            <table width="200" border="0" cellpadding="0" cellspacing="3">
              ...
              <tr>
                <td><div align="center"><img src="dynamic_cpt/right/<?php echo $leftpanelcontent['photo'];?>" width="150" height="120" /></div></td>
              </tr>
			  <?php }?>
              <tr>
              ...
              <tr>
                <td><div align="center"><img src="dynamic_cpt/right/<?php echo $leftpanelcontent['photo2'];?>" width="150" height="120" /></div></td>
              </tr><?php }?>
              <tr>
                <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td><div align="center"><img src="dynamic_cpt/right/<?php echo $leftpanelcontent['photo3'];?>" width="150" height="120" /></div></td>
              </tr><?php }?>
              <tr>
                <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td><div align="center"><img src="dynamic_cpt/right/<?php echo $leftpanelcontent['photo4'];?>" width="150" height="120" /></div></td>
              </tr><?php }?>
              <tr>
                <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td><div align="center"><img src="dynamic_cpt/right/<?php echo $leftpanelcontent['photo5'];?>" width="150" height="120" /></div></td>
              </tr><?php }?>
              <tr>
                <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td valign="top"><div align="right"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image50','','images/pointer_03b.gif',1)" onclick="window.open('morerightpanel.php?id=<?php echo $leftpanelcontent['id']?>','_blank','width=575,height=800,scrollbars=yes,status=no,location=no');"><img src="images/more.gif" width="50" height="18" border="0" /></a></div></td>
              </tr>
            </table>
          <?php }?>          </td>
        </tr>
