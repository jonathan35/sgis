...
<table width="100%" align="left" cellpadding="2"  cellspacing="3">
	<form name="form1" method="post" action="editNews.php?id=<?php echo $_GET['id']?>" enctype="multipart/form-data">
	<tr>
...
<th align="right" bgcolor="#EFEFEF" class="main_title" valign="top"><strong>Image : </strong><br>
          ...
          <td class="content"> Photo 1&nbsp;&nbsp;&nbsp;<?php if($selected['image1']!=''){?><a href="editNews.php?<?php echo $_SERVER['QUERY_STRING']?>&wp=1"><img src="../images/b_drop.png" width="16" height="15" border="0"></a><?php }?><br>
	...
	<tr>
	  ...
	  <td><input name="pdf_file" type="file" id="pdf_file"><?php if($selected['pdf_file']!=''){?> 
		<a href="editNews.php?id=<?php echo $_GET['id']?>&cmd=pdf">
